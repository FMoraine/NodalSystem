...
{
    public class ScrewdriverTranslateWheel : RotatableObject
    {
        ...
        protected override void Awake()
        {
            ...
            toothAngle = 360.0f / ToothsNumber;
        ...
        public void SetCurrentToothIndex(int ToothIndex)
        {
            currentToothIndex = ToothIndex;

            float angle = currentToothIndex * toothAngle;

            _objectTransform.localRotation = Quaternion.AngleAxis(angle, Vector3.forward);
        }
